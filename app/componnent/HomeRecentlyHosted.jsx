...
import homerecentlyhosted from "../../public/homerecentlyhosted.png";
import Container from "./Container";

const HomeRecentlyHosted = () => {
    return (
                ...
                <div className="flex flex-col gap-8 md:gap-10 md:flex-row">
                    ...
                    <div className="w-full h-[480px] flex gap-4">
                        ...
                        <div className="pl-2 pr-4">
                            <h1 className="text-4xl font-bold pCl">RECENTLY HOSTED REUNION PROGRAM.</h1>
                            <p className="py-10">
...
export default HomeRecentlyHosted;